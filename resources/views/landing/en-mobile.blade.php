...
<body data-spy="scroll" data-target="#navbar" data-offset="30">
                    ...
                    <nav class="navbar navbar-dark navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="navbar">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item"><a href="{{asset('HACHINET_profile.pdf')}}" target="_blank" class="btn btn-outline-light my-3 my-sm-0 ml-lg-3">Download PROFILE</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
    ...
    <header class="bg-gradient" id="home">
        <div class="container mt-5">
            <h1>Mobile and Application development</h1>
        ...
        <div class="container">
            ...
            <div class="card-deck">
                ...
                <div class="card pricing ">
                    <div class="card-head">
                        <small class="text-primary">LABO PROJECT</small>
                        <span class="price">2000 USD<sub>/MM</sub></span>
                    </div>
                    <ul class="list-group list-group-flush">
