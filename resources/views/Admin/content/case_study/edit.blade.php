        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('case-study.update', $dataJp->productId)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="tab-content tabcontent-border">
                                    <div class="tab-pane active p-3" id="japan" role="tabpanel">
                                        <div class="p-3">
                                            <div class="form-group">
                                                <input type="text" name="title_jp" id="title" placeholder="Title" value="{{$dataJp->productTitle}}" required
                                            ...
                                            <div class="form-group">
                                                <textarea id="product_content_jp" name="product_content_jp" placeholder="Content">{{$dataJp->productContent}}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                placeholder="Responsibility" class="form-control">{{ $dataJp->productResponsibility}}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                placeholder="Industry" class="form-control">{{$dataJp->productIndustry}}</textarea>
                                                @error('industry_jp')
                                                    <div class="alert alert-danger">{{ 'The field is required.' }}</div>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                class="form-control" value="{{$dataJp->productOverview}}">
                                                @error('overview_jp')
                                                    <div class="alert alert-danger">{{ 'The field is required.' }}</div>
                                                @enderror
                                            </div>
                                            <div class="form-group mb-0">
                                                ...
                                                class="form-control" value="{{$dataJp->productTech}}">
                                                @error('tech_jp')
                                                    <div class="alert alert-danger">{{ 'The field is required.' }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="tab-pane p-3" id="english" role="tabpanel">
                                        <div class="p-3">
                                            <div class="form-group">
                                                <input type="text" name="title_en" id="title" placeholder="Title" class="form-control" value="{{$dataEn->productTitle}}">
                                            </div>
                                            <div class="form-group">
                                                <textarea id="product_content_en" name="product_content_en" placeholder="Content">{{$dataEn->productContent}}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <textarea type="text" cols="30" rows="3" name="responsibility_en" id="responsibility" placeholder="Responsibility" class="form-control">{{$dataEn->productResponsibility}}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <textarea type="text" cols="30" rows="3" name="industry_en" id="description" placeholder="Industry" class="form-control">{{$dataEn->productIndustry}}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <input type="text" name="overview_en" id="keyword" placeholder="Overview" class="form-control" value="{{$dataEn->productOverview}}">
                                            </div>
                                            <div class="form-group mb-0">
                                                <input type="text" name="tech_en" id="keyword" placeholder="Technical information" class="form-control" value="{{$dataEn->productTech}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane p-3" id="vietnamese" role="tabpanel">
                                        <div class="p-3">
                                            <div class="form-group">
                                                ...
                                                value="{{$dataVn->productTitle}}"
                                                class="@error('title_vn') is-invalid @enderror form-control">
                                            </div>
                                            <div class="form-group">
                                                <textarea id="product_content_vn" name="product_content_vn" placeholder="Content">{{$dataVn->productContent}}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <textarea type="text" cols="30" rows="3" name="responsibility_vn" id="responsibility" placeholder="Responsibility" class="form-control">{{$dataVn->productResponsibility}}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <textarea type="text" cols="30" rows="3" name="industry_vn" id="description" placeholder="Industry" class="form-control">{{$dataVn->productIndustry}}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <input type="text" name="overview_vn" id="keyword" placeholder="Overview" class="form-control" value="{{$dataVn->productOverview}}">
                                            </div>
                                            <div class="form-group mb-0">
                                                <input type="text" name="tech_vn" id="keyword" placeholder="Technical information" class="form-control" value="{{$dataVn->productTech}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        @if ($dataJp->oldImages)
                                        <input type="text" name="old_listImages" id="old_listImages" value="{{$dataJp->oldImages}}" hidden>
                                        <div class="box-list__images" id="old__Images"></div>
                                        @endif
...
<script src="{{asset('admin/js/tinymce.min.js')}}"></script>
    <script>
        var listImages = [];
        var oldImages = $('#old_listImages').val().split(',');
        setTimeout(() => {loadOldImages();},500);
        function loadOldImages() {
            var strHtml = '';
            oldImages.forEach((s, i) => {
                strHtml += '<div class="single_image d-inline-block position-relative">';
                strHtml += '<img src="{{asset('upload')}}/'+s+'" alt="" />';
                strHtml += '<a href="javascript:removeOldImagesWithIndex('+i+');" class="text-danger position-absolute close__image" data-id="'+i+'">Remove</a>';
                strHtml += '</div>';
            });
            var strImages = oldImages.join();
            $('#old__Images').html(strHtml);
            $('#old_listImages').attr('value', strImages);
        }

        
        function removeOldImagesWithIndex(e) {
            oldImages.splice(e, 1);
            setTimeout(() => {
                loadOldImages();
            }, 500);
        }
