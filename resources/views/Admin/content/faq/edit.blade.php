        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('faqs.update', $dataJp->faqsId)}}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="tab-content tabcontent-border">
                                    <div class="tab-pane active p-3" id="japan" role="tabpanel">
                                        <div class="p-3">
                                            <div class="form-group">
                                                <input type="text" name="title_jp" id="title" placeholder="Question" value="{{$dataJp->faqsTitle}}" required
                                            ...
                                            <div class="form-group">
                                                <textarea id="post_content_jp" name="post_content_jp" placeholder="Content">{{$dataJp->faqsContent}}</textarea>
                                    ...
                                    <div class="tab-pane p-3" id="english" role="tabpanel">
                                        <div class="p-3">
                                            <div class="form-group">
                                                <input type="text" name="title_en" id="title" placeholder="Question" class="form-control" value="{{$dataEn->faqsTitle}}">
                                            </div>
                                            <div class="form-group">
                                                <textarea id="post_content_en" name="post_content_en" placeholder="Content">{{$dataEn->faqsContent}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane p-3" id="vietnamese" role="tabpanel">
                                        <div class="p-3">
                                            <div class="form-group">
                                                <input type="text" name="title_vn" id="title" placeholder="Question" value="{{$dataVn->faqsTitle}}"
                                                class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <textarea id="post_content_vn" name="post_content_vn" placeholder="Content">{{$dataVn->faqsContent}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
