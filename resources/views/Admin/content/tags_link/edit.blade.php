        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-8">
                            <form action="{{route('tagslink.update', $tags->id)}}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="">Tags Japanese</label>
                                    <input type="text" name="tagsJp" id="tagsJp" class="form-control" placeholder="Text Tags" value="{{$tags->keyJp}}">
                                    @error('tagsJp')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tagsEn" id="tagsEn" class="form-control" placeholder="Text Tags" value="{{$tags->keyEn}}">
                                </div>
                                <div class="form-group">
                                    <label for="">Tags Vietnamese</label>
                                    <input type="text" name="tagsVn" id="tagsVn" class="form-control" placeholder="Text Tags" value="{{$tags->keyVn}}">
                                </div>
                                <div class="form-group">
                                    <label for="">Tags Link</label>
                                    <input type="text" name="tagsLink" id="tagsLink" class="form-control" placeholder="Text Link" value="{{$tags->tagsLink}}">
                                    @error('tagsLink')
                                        <div class="alert alert-danger">{{ 'The field is required.' }}</div>
                                    @enderror
                                </div>
