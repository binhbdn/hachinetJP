<template>
    <div class="card">
        <div class="card-block">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <button class="btn btn-success" @click="update(info_setting.id)">Cập nhật</button>
                    </div>
                </div>
        </div>
    </div>
    ...
    export default {
        ...
        methods:{
                ...
                this.$validate()
                  .then(function (success) {
                    if(success == true)
                    {
                        ...
                        axios.post('api/settings/update', fileData).then(response => {
            ...
            fetchData(){
                ...
                axios.post('api/settings/edit', {'id': this.id}).then(response => {
                    this.info_setting = response.data.settings;
                    if(this.info_setting.logo !== ''){
                        this.logo = '/upload/setting/'+this.info_setting.logo;
                    }else{
                        this.logo = '../uploads/setting/1531908563.devworkvn-png-beta.png'
                    }
                    if(this.info_setting.logoheader !== ''){
                        this.logoheader = '/upload/setting/'+this.info_setting.logoheader;
                    }else{
                        this.logoheader = '../uploads/setting/1531908563.devworkvn-png-beta.png'
                    }
                    if(this.info_setting.logofooter !== ''){
                        this.logofooter = '/upload/setting/'+this.info_setting.logofooter;
                    }else{
                        this.logofooter = '/uploads/setting/1531908563.devworkvn-png-beta.png'
                    }
                    if(this.info_setting.favicon !== ''){
                        this.favicon = '/upload/setting/'+this.info_setting.favicon;
                    }else{
                        this.favicon = '../upload/setting/1531908563.devworkvn-png-beta.png'
                    }
                }); 
            },
            ...
            'checkExisimage': function(){
                if(this.image_req !== ''){
                    this.messageImage = '';
                }else{
                    this.messageImage = 'Ảnh bắt buộc nhập';
                }    
            },
        },
        mounted(){
