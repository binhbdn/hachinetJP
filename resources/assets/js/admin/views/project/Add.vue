                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form novalidate="novalidate">
                            ...
                            <div class="form-group">
                                <label for="title">Tiêu đề dự án</label>
                            ...
                            <div class="form-group">
                                <label for="description">Mô tả gắn về dự án</label>
                            ...
                            <div class="form-group">
                                ...
                                <vue-html5-editor :content="content" @change="checkeditor" :height="500"></vue-html5-editor>
...
export default {
    ...
    'onFilechange': function(e){
      ...
      'createImage': function(file){
        ...
        addBlog() {
          // this.blog.content = $('.content').html();
            let $this = this;
        this.$validate()
          .then(function (success) {
            if(success == true)
            {
                ...
                axios.post('/api/project/store', fileData).then(response => {
