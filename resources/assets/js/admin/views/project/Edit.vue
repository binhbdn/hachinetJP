                    ...
                    <div class="card-body">
                        ...
                        <form novalidate="novalidate">
                            <div class="form-group">
                                ...
                                <select id="category" v-model="blog.id_category" class="form-control">
                                    <option :value="c.id" v-for="c in category">{{ c.name }}</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <vue-html5-editor :content="content" v-model="blog.content" @change="checkeditor" :height="500"></vue-html5-editor>
                            ...
                            <button type="button" class="btn btn-default" @click="updateBlog(blog.id)">Thêm mới</button>
                        </form>
                    </div>
                </div>
            </div>
      ...
      'createImage': function(file){
        ...
        this.$validate()
          .then(function (success) {
            if(success == true)
            {
                ...
                axios.post('/api/project/update', fileData).then(response => {
        ...
        getBlog() {
            let self = this;
                ...
                axios.post('/api/project/edit', {'id': this.id}).then(response => {
                    this.blog = response.data.blog;
                    this.content = this.blog.content;
                    if(this.blog.images !== ''){
                        this.image = '../upload/project/'+this.blog.images;
                    }else{
                        this.image = ''
                    }
                });
